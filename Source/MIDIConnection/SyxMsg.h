...
/*			if (m_addressArray != nullptr) delete[] m_addressArray;
	...
	*/
	...
	uint8 getInquiryReplyDevId() { return m_deviceId; }
	uint8 getInquiryReplyManId() { return m_dataArray[0]; }
	uint16 getInquiryReplyDevFamCode() { return m_dataArray[1] << 8 | m_dataArray[2]; }
	uint16 getInquiryReplyDevFamNumberCode() { return m_dataArray [3] << 8 | m_dataArray[4]; }
	uint32 getInquiryReplySoftwareRevision() { return m_dataArray[5] << 24 | m_dataArray[5] << 16 | m_dataArray[5] << 8 | m_dataArray[8]; }
	...
	uint8 getDeviceId() { return m_deviceId; }
	...
	uint32 getBlockStartAddress() { return get32BitAddress() & 0xFFFF0000; };

	uint16 getAddressOffset() { return get32BitAddress() & 0x0000FFFF; }

	bool isCheckSumOkay() { return m_checkSumOkay; }
