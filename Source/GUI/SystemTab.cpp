...
//==============================================================================
void SystemTab::paint (Graphics& g)
{
...
void SystemTab::resized()
{
	...
	m_logoDrawable->setBounds(16, 16, m_midiInLabel->getX() - 16, 300);
	m_logoDrawable->setTransformToFit(m_logoDrawable->getBounds().toFloat(), RectanglePlacement::onlyReduceInSize);
    //[/UserResized]
}

void SystemTab::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
...
void SystemTab::buttonClicked (Button* buttonThatWasClicked)
{
...
void SystemTab::mouseDrag (const MouseEvent& e)
{
...
bool SystemTab::isInterestedInFileDrag(const StringArray &files)
{
...
void SystemTab::filesDropped(const StringArray &files, int /*x*/, int /*y*/)
{
	if (files.size() > 0)
	{
...
<JUCER_COMPONENT documentType="Component" className="SystemTab" componentName=""
                 parentClasses="public Component, public FileDragAndDropTarget, public DragAndDropContainer"
...
static const unsigned char resource_SystemTab_audioxmidi_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,64,0,0,0,64,8,6,0,0,0,170,105,113,222,0,0,0,4,115,66,73,84,8,8,8,8,124,8,100,136,
...
const char* SystemTab::audioxmidi_png = (const char*) resource_SystemTab_audioxmidi_png;
const int SystemTab::audioxmidi_pngSize = 3650;
