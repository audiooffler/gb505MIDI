...
public:
	//==============================================================================
	ToneMixTableToneVeloXFade(const String &componentName, Component* componentToWatch, ToneLimitsConstrainer* toneLimitsConstrainer, SynthParts part, Tone tone);
...
private:
	...
	SynthParts m_part;
	Tone m_tone;
	Parameter* m_velocityXFadePrm;
	Parameter* m_toneLevelPrm; // 0x65
	Parameter* m_biasDirectionPrm; // 0x66
	Parameter* m_biasPointPrm; // 0x67
	Parameter* m_biasLevelPrm; // 0x68
    //[/UserVariables]
