...
void WaveformButton::paint (Graphics& g)
{
	...
	setColour(buttonColourId, m_highlight ? Colour(0xffF2F59B).brighter(1.0f) : Colour(0xffF2F59B));
	setColour(buttonOnColourId, m_highlight ? Colour(0xffC4C86D).brighter(1.0f) : Colour(0xffC4C86D));
